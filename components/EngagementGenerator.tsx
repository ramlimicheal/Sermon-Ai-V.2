...
import { generateEngagementContent } from '@/services/megaLLMService';
import { EngagementItem, Language } from '@/types';
...
export const EngagementGenerator: React.FC<EngagementGeneratorProps> = ({ scripture, language }) => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      console.error('Engagement generation error:', err);
      setState({ data: null, loading: false, error: "Failed to generate engagement content. Please check your API key and try again." });
    }
  };
